...
class _ProductScreenBody extends StatelessWidget {
  ...
  Future<void> _selectAndUploadImage(
      BuildContext context, ProductFormProvider productForm) async {
    final ImagePicker _picker = ImagePicker();
    final XFile? image = await _picker.pickImage(source: ImageSource.gallery);

    if (image == null) return;

    // Aquí implementas la lógica para subir la imagen a tu servidor o almacenamiento en la nube
    // y obtener la URL de la imagen subida.
    String imageUrl = await uploadImageToServer(image.path);

    // Actualiza el estado del producto con la nueva URL de la imagen
    productForm.product.productImage = imageUrl;
  }

  Future<String> uploadImageToServer(String filePath) async {
    // Implementa la lógica de subida de la imagen
    // Ejemplo:
    // String imageUrl = await myCloudStorageService.uploadImage(filePath);
    // return imageUrl;
            ...
            Stack(
              children: [
                ...
                Positioned(
                  ...
                  child: IconButton(
                    onPressed: () {
                      _selectAndUploadImage(context, productForm);
                    },
          ...
          child: Column(
            children: [
              ...
              SwitchListTile.adaptive(
                value: product.productState.toLowerCase() == 'disponible',
                onChanged: (value) => product.productState =
